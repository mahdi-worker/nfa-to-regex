...
})({"9b5U9":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "03b59b62db58729a";
"use strict";
...
},{}],"eZNLs":[function(require,module,exports) {
...
var DocumentColorAdapter = class {
    ...
    provideColorPresentations(model1, info, token1) {
        const resource = model1.uri;
...
var ParentsStack = class {
    ...
    static push(parents1, type1) {
        return new ParentsStack(parents1, type1);
    }
    static equals(a, b) {
        if (!a && !b) return true;
        if (!a || !b) return false;
...
var JSONDiagnosticsAdapter = class extends DiagnosticsAdapter {
    constructor(languageId, worker1, defaults){
        super(languageId, worker1, defaults.onDidChange);
...
},{"../../editor/editor.api.js":"acwnq","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["9b5U9"], null, "parcelRequire9cf5")

//# sourceMappingURL=jsonMode.db58729a.js.map
